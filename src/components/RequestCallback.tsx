...
const RequestCallback = () => {
  return (
    <div className={`request-callback-container frame h-[700px] md:h-[300px] bg-gradient-to-r from-red-500 to-yellow-500 mx-7 rounded-tr-[5rem]   flex justify-between items-center flex-col  mb-[2rem] md:flex-row  `}>
